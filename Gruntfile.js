...
module.exports = function(grunt) {
    ...
    jsSharedFiles = jsSharedFiles.map(function(path) {
        return '.tmp/public/js/shared/' + path;
    });

    topLevelJsToInject = topLevelJsToInject.map(function(path) {
        return '.tmp/public/' + path;
    });
    ...
    /*.coffee'],
        ...
        concat: {
            topJs: {
                src: topLevelJsToInject,
                dest: '.tmp/public/concat/libs.js'
            },
            js: {
                src: jsSharedFiles.concat(jsFilesToInject),
        ...
        'sails-linker': {
            topDevJs: {
                ...
                files: {
                    'views/_meta/*.jade': topLevelJsToInject
                }
            },
            ...
            devJs: {
                ...
                files: {
                    'views/_meta/*.jade': jsSharedFiles.concat(jsFilesToInject)
                }
            },
            ...
            devStyles: {
                ...
                files: {
                    'views/_meta/*.jade': cssFilesToInject
                }
            },
            ...
            devTpl: {
                ...
                files: {
                    'views/_meta/*.jade': ['.tmp/public/jst.js']
                }
            }
            /************************************
             * Jade linker end
